#!/usr/bin/python
#
# trhackd0rk3r.py - a modified smartd0rk3r
#   - added dork array
...
def logo():
	print R+"\n|---------------------------------------------------------------|"
        print "| trhackd0rk3r.py - a modified darkd0rk3r.py                     |"
        print "|   10/2012        - v.0.3                                      |"
        print "|     trhacknon           - trhacknon@protonmail.com                    |"
...
log = "trhackd0rk3r-sqli.txt"
logfile = open(log, "a")
lfi_log = "trhackd0rk3r-lfi.txt"
lfi_log_file = open(lfi_log, "a")
rce_log = "trhackd0rk3r-rce.txt"
rce_log_file = open(rce_log, "a")
xss_log = "trhackd0rk3r-xss.txt"
...
xsses = ["<h1>XSS by trhacknon </h1>","%3Ch1%3EXSS%20by%20trhacknon%3C/h1%3E"]
